...
# manhattan_Test.rds
download.file(
    'https://query.data.world/s/ghbw3g735aso3da4u5i6lqkgy7hcaa',
...
# manhattan_Train.rds
download.file(
    'https://query.data.world/s/isrwjvdanf23cyn6s7n3jzpidfbj4m',
    destfile=file.path(dataDir, 'manhattan_Train.rds'),
    mode='wb')

# manhattan_Validate.rds
download.file(
    'https://query.data.world/s/fvr7lk25vuyrsozhcnluqx5ogcycml',
